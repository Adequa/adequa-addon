    ...
    <div id="popup">
        <div>
            <transition :name="transition" class="transition" mode="in-out">
                <router-view :nb-cookies="cookies.length" :show-dev-features="showDevFeatures"></router-view>
            </transition>
...
<script>
    export default {
        ...
        created(){
            Adequa.API.runtime.sendMessage({what: "openPopup"}, (showDevFeatures) => {
                this.showDevFeatures = showDevFeatures;
            });
