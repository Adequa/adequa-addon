<template>
    <div>
        <purpose-setting v-for="purpose of purposes" :key="purpose.id" :purpose="purpose" :setting="getSetting[purpose.id]" :is-default="!websiteSettings" :website-id="websiteId" @settingChanged="updateSetting"></purpose-setting>
    </div>
</template>
