...
function appendAds() {
    ...
    vAPI.messaging.send(
        ...
        { what: 'getPopupData' },
        function(received) {
            var selectedCategories = received.adequaSelectedCategories;
                ...
                if (leMondeAdsFormats[adFormat]) {
                    ...
                    if (bestSize) {
                        ...
                        div.innerHTML =
                            ...
                            '<span style="display: table-cell;text-align: center;vertical-align: middle;color: white;font-weight: bold;line-height: 21px;font-size:19px;">Adequa ' + bestSize[0] + 'x' + bestSize[1] + '<br />(' +selectedCategories.join(',') + ')</span>' +
                            '</div>';
                        currentAdElement.appendChild(div);
                        // TRASH
                        currentAdElement.style = "display:block !important";
                    }
                }
            }
        }
